...
<div class="menu"><a href="#add" id='add' >Поделиться</a>|<a href="#" >Найти запись</a>|<a href="#" >Отобразить все записи</a>|<a href="#" >Кролик:D</a></div>
<div class="ashow lr">
<h2 class="l">Ваши секреты</h2>
<?=$problems;?></div>

<div class="ashow rl">
<h2 class="l" >Ваши Проблемы</h2>
<?=$issues;?>
<a href="#" class="go" >previous</a>
<br />Запис 2<br /><br /><br />
<a href="#"  class="go">next</a><br />
Проблема<br /><input type="button" value="кнопка перехода"  /></div>
</div>
